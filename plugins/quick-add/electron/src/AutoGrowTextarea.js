...
export default class GrowingTextarea extends Component {
  ...
  resize = () => {
    ...
    if (!this.props.value.trim()) {
      ...
      console.log('just single', height, style.lineHeight, style.paddingTop, style.paddingBottom, style.fontSize, lineHeight)
      */
    } else {
      height = style.height
    }
    if (
      ...
      this.props.onHeightChange(parseFloat(height), parseFloat(this._prevHeight))
    }
